          ...
          <div className="prose prose-lg prose-gray dark:prose-invert max-w-none">
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-6 rounded-r-lg">
              ...
              <p className="text-gray-700 dark:text-gray-300 mt-3">
                Read our <a href="/privacy" className="text-blue-600 dark:text-blue-400 underline">Privacy Policy</a> for full details.
              </p>
            </div>
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li>• Visit our <a href="/contact" className="text-blue-600 dark:text-blue-400 underline">Contact Page</a></li>
              <li>• Check out our <a href="/blog" className="text-blue-600 dark:text-blue-400 underline">Blog</a> for tips and guides</li>
              <li>• Read our <a href="/privacy" className="text-blue-600 dark:text-blue-400 underline">Privacy Policy</a></li>
            </ul>
