...
const Privacy = () => {
  return (
    ...
    >
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-gray-900 py-12 sm:py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg prose-gray dark:prose-invert max-w-none">
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-l-4 border-green-500 p-4 sm:p-6 mb-6 sm:mb-8 rounded-r-lg shadow-sm">
              <h3 className="text-lg sm:text-xl font-bold text-green-800 dark:text-green-300 mb-2 flex items-center gap-2">
                <span className="text-2xl">🎉</span> Good News!
              </h3>
              <p className="text-green-700 dark:text-green-200 text-base sm:text-lg leading-relaxed">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-8 sm:mt-10 mb-4 sm:mb-6">
              What We DON'T Collect
            </h2>
            
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 p-4 sm:p-6 rounded-xl mb-6 shadow-sm">
            ...
            <ol className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-700 dark:text-gray-300 list-decimal list-inside">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-4 sm:p-6 mt-8 sm:mt-10 shadow-md border border-blue-100 dark:border-blue-800">
            ...
            <div className="mt-8 sm:mt-10 p-4 sm:p-6 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 text-sm sm:text-base">
                <div className="flex items-start gap-2">
                  ...
                  <span className="text-gray-700 dark:text-gray-300">No signup required</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-500 text-lg">✓</span>
                ...
                <div className="flex items-start gap-2">
                  <span className="text-green-500 text-lg">✓</span>
                  <span className="text-gray-700 dark:text-gray-300">No cookies or tracking</span>
                </div>
                <div className="flex items-start gap-2">
                  <span className="text-green-500 text-lg">✓</span>
                  <span className="text-gray-700 dark:text-gray-300">100% anonymous usage</span>
                </div>
              </div>
            </div>
          </div>
