    ...
    >
      ...
      <div className="min-h-screen bg-background relative overflow-hidden">
        ...
        <article className="container max-w-4xl mx-auto px-4 pt-24 pb-20 relative z-10">
          ...
          >
            <Link to="/blog" className="hover:text-primary transition-colors flex items-center gap-1 group">
          ...
          <motion.div
            ...
            className="glass-card p-8 md:p-12 bg-background/40 backdrop-blur-xl border-white/5"
          >
          ...
          {/* Author Bio */}
          <div className="mt-12 p-8 rounded-3xl bg-white/5 border border-white/10 flex flex-col sm:flex-row gap-6 items-center sm:items-start text-center sm:text-left backdrop-blur-md">
            ...
            {relatedPosts.map((relatedPost, index) => (
              ...
              >
                <Link
                  ...
                  className="group bg-card/50 border border-white/10 rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-primary/5 transition-all duration-500 hover:-translate-y-2 block h-full backdrop-blur-sm"
                >
