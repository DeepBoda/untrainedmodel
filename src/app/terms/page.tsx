        ...
        <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-gray-900 py-12 sm:py-16 md:py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="prose prose-lg prose-gray dark:prose-invert max-w-none">
                    ...
                    <h3 className="text-xl font-semibold text-green-700 dark:text-green-400 mt-6 mb-3">
                    ...
                    <h3 className="text-xl font-semibold text-red-700 dark:text-red-400 mt-6 mb-3">
                    ...
                    <div className="bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-6 rounded-r-lg">
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mt-3">
                            Read our <Link href="/privacy" className="text-blue-600 dark:text-blue-400 underline">Privacy Policy</Link> for full details.
                        </p>
                    </div>
                    ...
                    <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                        <li>• Visit our <Link href="/contact" className="text-blue-600 dark:text-blue-400 underline">Contact Page</Link></li>
                        <li>• Check out our <Link href="/blog" className="text-blue-600 dark:text-blue-400 underline">Blog</Link> for tips and guides</li>
                        <li>• Read our <Link href="/privacy" className="text-blue-600 dark:text-blue-400 underline">Privacy Policy</Link></li>
                    </ul>
